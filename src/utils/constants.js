...
export const featuredServices = [
  {
    ...
    copy: "Roofing solutions for commercial properties, facilities, and organizations with a focus on dependable installation, repair, and long-term performance.",
    items: ["Commercial roof systems", "TPO roofing", "Repairs & maintenance"],
  },
  {
    number: "02",
    title: "Roof Coatings & Restoration",
    copy: "Roof coating and restoration systems designed to help extend roof service life and address eligible commercial roofing needs without unnecessary replacement.",
    items: ["Roof coatings", "Restoration systems", "Maintenance planning"],
  },
  {
    number: "03",
    title: "Repairs & Maintenance",
    copy: "Responsive roofing repairs and ongoing maintenance for leaks, weather damage, flashing issues, and other conditions that can affect roof performance.",
    items: ["Leak detection", "Storm damage repair", "Preventive maintenance"],
  },
  {
    number: "04",
    title: "Roof Repair",
    copy: "Targeted repairs for leaks, damaged shingles, flashing problems, and other visible roofing issues.",
    items: ["Flashing repair", "Emergency roof repair"],
  },
  {
    number: "05",
  ...
  },
  {
    ...
    items: ["Insurance claim assistance"],
  },
];
